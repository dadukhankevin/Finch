import random
from Finch.generic import Individual, make_callable
...
class Select:
    ...
    def __init__(self, percent_to_select=None, amount_to_select=None):
        ...
        if percent_to_select is None:
            self.percent_to_select = None
        if amount_to_select is None:
            self.amount_to_select = None
