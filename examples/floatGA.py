...
expression = """x**x**x + y + z**z**z"""  # the equation with unkown variables
print("in")
...
env = Environments.SequentialEnvironment(layers=[  # Define the environment
    ...
    l.Parents(pool, gene_size=1, family_size=2, percent=100, every=4, method="best", amount=4),
    # parents the best ones.
    l.OverPoweredMutation(pool=pool, iterations=100, index=-1, fitness_function=fitness),
